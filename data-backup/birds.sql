...
CREATE TABLE public.birds (
    id integer NOT NULL,
    "speciesName" character varying(255) NOT NULL,
...
--
-- Name: birds_id_seq; Type: SEQUENCE; Schema: public; Owner: app_dev
--
...
ALTER TABLE public.birds_id_seq OWNER TO app_dev;

--
-- Name: birds_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: app_dev
--
...
--
-- Name: birds id; Type: DEFAULT; Schema: public; Owner: app_dev
--
...
--
-- Name: birds birds_speciesName_key; Type: CONSTRAINT; Schema: public; Owner: app_dev
--

ALTER TABLE ONLY public.birds
    ADD CONSTRAINT "birds_speciesName_key" UNIQUE ("speciesName");
